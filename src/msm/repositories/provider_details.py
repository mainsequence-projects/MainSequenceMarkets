...
from msm.models import OpenFigiDetails
...
def build_get_openfigi_details_by_uid_operation(
    ...
    *,
    ...
    return build_get_model_by_uid_operation(context, model=OpenFigiDetails, uid=uid)
...
def build_delete_openfigi_details_operation(
    ...
    *,
    ...
    return build_delete_model_operation(context, model=OpenFigiDetails, uid=uid)
