...
_EXPORTS = {
    "ASSET_MASTER_LIST_VALIDATION_VERSION": ".asset_master_lists",
    "AssetMasterListValidationError": ".asset_master_lists",
    "AssetReferenceMetaTableValidationResult": ".asset_master_lists",
    "REQUIRED_ASSET_REFERENCE_META_TABLE_COLUMNS": ".asset_master_lists",
    "append_asset_category_membership": ".asset_categories",
    "build_account_holdings_frame": ".holdings",
    "build_asset_snapshot_frame": ".asset_snapshots",
    "build_asset_snapshot_node": ".asset_snapshots",
    "build_create_validated_asset_master_list_operation": ".asset_master_lists",
    "build_fund_holdings_frame": ".holdings",
    "build_holdings_frame": ".holdings",
    "build_resolve_asset_master_list_operation": ".asset_master_lists",
    ...
    "create_validated_asset_master_list": ".asset_master_lists",
    ...
    "resolve_asset_master_list": ".asset_master_lists",
    ...
    "update_asset_snapshot_frame": ".asset_snapshots",
    "update_asset": ".assets",
    ...
    "upsert_asset": ".assets",
    "validate_asset_master_list_reference_meta_table": ".asset_master_lists",
