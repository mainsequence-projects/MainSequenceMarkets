...
class MarketCap(SignalWeights):
    ...
    def _calculate_signal_weights(self):
        ...
        market_cap_uid_range_map = {
            asset_spot_reference_unique_identifier(asset): unique_identifier_range_market_cap_map[
        ...
        market_cap_uid_to_asset_uid = {
            asset_spot_reference_unique_identifier(asset): asset_unique_identifier(asset)
            for asset in asset_list
        }
