...
See `examples/msm/assets/bond_workflow.py` for a minimal workflow that creates an
issuer, a USD currency asset, and a USD bond using the user-facing API.

See `examples/msm/assets/us_treasury_bond_workflow.py` for a concrete US Treasury
example using:
