...
`key_nodes` records compressed-at-rest producer-owned provenance for the dated
input quotes used to build the specific observation row. Producers should use
