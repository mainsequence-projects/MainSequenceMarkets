...
def run() -> dict[str, object]:
    """Return normalized intraday/daily observations and methodology identity rules."""
    ...
    methodology_identity = {
        ...
        # A prospective economic-method change uses definition versions under one identity.
        "prospective_definition_versions": (INDEX_IDENTIFIER, "v1 -> v2"),
...
if __name__ == "__main__":
    ...
    print(output["methodology_identity"])
